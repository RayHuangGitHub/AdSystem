...
public class AdItem {
	...
	public static class AdItemBuilder {
		...
		public AdItemBuilder setAd_id(int ad_id) {
			this.ad_id = ad_id;
			return this;
		}
		
		public AdItemBuilder setBid(float bid) {
			this.bid = bid;
			return this;
		}
		
		public AdItemBuilder setImage_url(String image_url) {
			this.image_url = image_url;
			return this;
		}
		
		public AdItemBuilder setAdvertiser_id(int advertiser_id) {
			this.advertiser_id = advertiser_id;
			return this;
		}
		
		public AdItemBuilder setAd_score(float ad_score) {
